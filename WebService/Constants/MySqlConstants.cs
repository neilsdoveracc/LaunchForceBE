...
namespace WebService.Constants
{
    public static class MySqlConstants
    {
        ...
        public static string CreateVendor = "INSERT INTO vendor_master (vendor_id,vendor_name,location_id,skills_set, modified_date) VALUES (@vendor_id,@vendor_name,@location_id,@skills_set, @modified_date)";
        public static string GetVendorList = "SELECT * FROM vendor_master order by created_date desc";
    }
}
